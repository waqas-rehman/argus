...
<div id="right">
	<div class="section">
		<div class="box">
			<div class="title">New Quotation<span class="hide"></span></div>
			<div class="content">
				<form id="dynamic_products_form" action="" method="post">
                
				<div class="row quotation_number_div"><a href="javascript:void(0);" onclick="javascript:window.print();">Print &gt;&gt;</a></div>
				
                <div class="row quotation_number_div">
                	<label for="quotation_number">Quotation Number</label>
					<div class="right"><input type="text" id="quotation_number" name="quotation_number" value="" /></div>
				</div>
                ...
                <table cellspacing="0" cellpadding="0" border="0"> 
					<thead> 
						<tr>
							<th>Product Group</th>
							<th>Products (ADL Code - Product Code)</th>
							<th>Quantity</th>
                ...
                <div class="row">
                    ...
                    <div class="right">
                    	<textarea id="quotation_notes" name="quotation_notes" rows="8" cols=""></textarea>
                    </div>
                </div>
                <br />
                <input type="hidden" id="sub_total_hidden" name="sub_total_hidden" value="0" />
                <input type="hidden" id="vat_total_hidden" name="vat_total_hidden" value="0" />
                <input type="hidden" id="freight_charges" name="freight_charges" value="0" />
...
$(function(){
	...
	$("#save_and_submit").click(function(){
		if(validate_form()) {
			$("#dynamic_products_form").attr("action","<?php echo base_url("quotations/products") ; ?>") ;
