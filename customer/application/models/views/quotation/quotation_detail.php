            ...
            <?php
				if($msg){
				  ...
				  if($msg == 12) echo '<div class="message green"><span>Order description information submitted/updated successfully</span></div>' ;
					if($msg == 13) echo '<div class="message green"><span>Order file information submitted/updated successfully</span></div>' ;
				}
			?>
                <div class="row">
                ...
                <div class="row">
					...
					?>
                        ...
                        <tr id="last2">
                            ...
                            <td id="sub_total"><?php echo get_decimal_number_format($temp_sub_total) ; ?></td>
                      	</tr>
                        ...
                        <tr id="last6">
                            ...
                            <td id="total_plus_vat"><?php echo get_decimal_number_format($temp_vat_tax  + $temp_sub_total) ;  ?></td>
                        </tr>
                    </tbody>
				</table>
			<?php } else { ?>
