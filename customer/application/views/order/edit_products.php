...
<div id="right">
	<div class="section">
		<div class="box">
			<div class="title">Order - Edit Products<span class="hide"></span></div>
			<div class="content">
					...
					<tbody>
                        ...
                        <tr id="tr_<?php echo $x ; ?>">
							...
							<td id="product_<?php echo $x ; ?>">
                                ...
                                <?php echo $rec->product_name. " - ".$rec->product_code. " - ".$rec->product_adl_code ; ?>
                            </td>
...
<input type="hidden" id="next_step" name="next_step" value="" />
                ...
                <div class="row">
                	<button id="add_description" type="button"><span>Add Description &gt;&gt;</span></button>&nbsp;
                    <button id="save_and_submit" type="button"><span>Save</span></button>&nbsp;
                    <button id="cancel_products" type="button"><span>Cancel</span></button>&nbsp;&nbsp;
                    <a href="<?php echo base_url("orders/order_detail/".$order_id) ; ?>">Order Details</a></div>
                </form >
			</div>
		</div>
	</div>
