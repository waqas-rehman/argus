...
<form id="customer_email_form" class="block-content form" action="" method="post"  enctype="multipart/form-data">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
            ...
            <td width="27%" align="left" valign="middle" style="padding:10px;"><img src="<?php echo base_url() ; ?>img/logo_argus.png" width="204" height="13%" align="right" style="display:block"></div></td>
            </tr>
          </table>
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:15px;">
            ...
            <strong><div mc:edit="std_content00">
                                                                <strong>Dear <?php echo $contact_person_name; ?>,</strong>
                                                                <p>Your company <?php echo  $client_name;?> <Name> has been added to the Argus Distribution Limited customer portal. Please activate your account using the link below. If you have any questions please do not hesitate to contact us</p>
                                                                <br />
			...
			<br />
              ...
              <table width="75%" border="0" cellspacing="0" cellpadding="4">
                <tr>
                  <td align="left" valign="top" style="font-family:Verdana, Geneva, sans-serif; font-size:14px; color:#000000;"><b></b></td>
                  </tr>
                <tr>
