                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_content00">
                                                                <strong>Dear <?php echo $customer_rec->contact_person_name ; ?>,</strong>
                                                                <p>Your company <?php echo $customer_rec->company_name  ; /**/ ?> person has requested Username/Password. Below is the information regarding your account.</p>
                                                                <br />
                                                                <p><strong>Username: </strong> <?php echo $user_rec->username ; ?></p>
                                                                <p><strong>Password: </strong><?php echo $passwordx ; ?></p>
                                                            	<p><a href="<?php echo "http://localhost/argus/customer/admin" ; ?>">Click here</a> to login</p>
                                                            </div>
														</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top" width="350">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; <?php echo date("Y") ; ?> *|LIST:COMPANY|*, All rights reserved.</em>
																<br />
