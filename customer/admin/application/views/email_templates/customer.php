                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <p>Your company <?php echo  $client_name  ; ?> have successfully registered with the Argus Distribution.</p>
                                                                <br />
                                                                <p><strong>Username: </strong> <?php echo $username ; ?></p>
                                                                <p><strong>Password: </strong><?php echo $password ; ?></p>
                                                            	<p><a href="<?php echo "http://portal.argusdistribution.co.uk" ; ?>">Click here</a> to login</p>
                                                            </div>
														</td>
                                                    </tr>
                                                </table>
