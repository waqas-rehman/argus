      ...
      <tr>
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:15px;">
            ...
            <strong>Dear <?php echo $contact_person_name; ?>,</strong>
                                                                <p>We can confirm that your order has been shipped. Your estimated delivery date is: <?php echo $insert_text ;?>. If you have any further queries, please do not hesitate to contact us.</p></td>
