    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:15px;">
            ...
            <strong>Dear <?php echo $contact_person_name; ?>,</strong><?php if($payment_status) { ?>
                                                                <p><?php echo $payment_status; ?></p><p><b><?php if ($insert_text !="") {?> Note:-<?php ?><?php echo $insert_text ; }}?></b></p></td>
