...
<body class="special-page">
  ...
  <div id="container">
    ...
    <section id="login-box">
    	...
    	<div class="block-border">
    		...
    		<form id="login-form" class="block-content form" action="<?php echo base_url() ; ?>home/login" method="post">
            
            <?php if($error) { ?>
            	<?php if($error == 1) { ?>
                	<p class="inline-small-label"><img src="<?php echo base_url("img/icons/packs/fugue/16x16/cross-button.png") ; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:14px !important;">Email/Password does not exists</b></p>
                <?php } ?>
			<?php } ?>
            
    			<p class="inline-small-label">
					<label for="username">Username</label>
					<input type="text" name="username" value="" class="required" autocomplete="off" />
				</p>
				<p class="inline-small-label">
					<label for="password">Password</label>
					<input type="password" name="password" value="" class="required" autocomplete="off" />
				</p>
    			...
    			<div class="block-actions">
					<ul class="actions-left">
						<li><a class="button" id="recover_password" name="recover_password" href="javascript:void(0);">Recover Password</a></li>
  ...
  <script type="application/javascript">
	$(function(){
		$("#recover_password").click(function(){ window.location.href = "<?php echo base_url("home/forget_username_password") ?>" ; }) ; 
	}) ;
  </script>
