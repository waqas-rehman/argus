        	...
        	<div class='block-border'>
                ...
                <form id="customer_form" class="block-content form" action="<?php echo base_url("customer/upadte_customer") ; ?>" method="post">
                	<fieldset>
						...
						<div class='_50'><p><label for="company_name">Company Name</label><input type="text" id="company_name" name="company_name" value="<?php echo $customer_rec->company_name ; ?>" /></p></div>
                        <div class='_50'><p><label for="contact_person_name">Contact Person Name</label><input type="text" id="contact_person_name" name="contact_person_name" value="<?php echo $customer_rec->contact_person_name ; ?>" /></p></div>
                        <div class='_50'><p><label for="email_address">Email Address</label><input type="text" id="email_address" name="email_address" value="<?php echo $customer_rec->email_address ; ?>" /></p></div>
                        <div class='_50'><p><label for="telephone_number">Telephone Number</label><input type="text" id="telephone_number" name="telephone_number" value="<?php echo $customer_rec->telephone_number ; ?>" /></p></div>
                    ...
                    <fieldset>
                        ...
                        <div class='_50'><p><label for="username">Username</label><input type="text" id="username" name="username" value="<?php echo $customer_login_rec->username ; ?>" /></p></div>
