	...
	<div class="container_12">
		...
		<div class='grid_12'>
        	<div class='block-border'>
				...
				?>
                <form id="customer_products_from" class="block-content form" action="<?php echo base_url("customer/add_customer_products") ; ?>" method="post">
                    <fieldset>
                    	<legend>Product Prices for <?php echo $customer_rec->company_name ; ?></legend>
                            ...
                            <table class="table">
								...
								<?php if($products) {  foreach($products as $rec): ?>
                                    <tr class='gradeX'>
                                        ...
                                        <td class='center'>
                                        	<input type="hidden" id="product_id_<?php echo $rec->id ; ?>" name="product_ids[]" value="<?php echo $rec->id ; ?>" />
                                            <input type="text" id="product_price_<?php echo $rec->id ; ?>" name="product_price_<?php echo $rec->id ; ?>" value="<?php echo $rec->product_price ; ?>" />
                                        </td>
                                    </tr>
                                <?php endforeach ; } ?>
								</tbody>
                    ...
                    <div class='block-actions'>
                        <ul class='actions-right'>
                        	<li><a id="submit_form" class="close-toolbox button" href="javascript:void(0);">Add Product Prices</a></li>
