        	...
        	<div class='block-border'>
                ...
                <form id="customer_form" class="block-content form" action="<?php echo base_url("customer/add_customer") ; ?>" method="post">
                	<fieldset>
                        ...
                        <div class='_50'><p><label for="email_address">Main Contact Email</label><input type="text" id="email_address" name="email_address" value="<?php echo set_value("email_address") ; ?>" /></p></div>
                        <div class='_50'><p><label for="email_address">Account Email</label><input type="text" id="account_email" name="account_email" value="<?php echo set_value("account_email") ; ?>" /></p></div>
