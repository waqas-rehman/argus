			...
			<div class='block-border'>
            	...
            	<div class='block-content'>
					<table id='table-example' class='table'>
						<thead>
                        	<tr>
                            	<th width="15%" class='center'>Purchase Order Number</th>
                                <th width="15%" class='center'>Status</th>
                                <th width="25%" class='center'>Invoice Date</th>
								<th width="25%" class='center'>Invoice Amount</th>
                        ...
                        <tbody>
                            ...
                            <tr class='gradeX'>
                                ...
                                <td class='center'><?php echo date("d/m/Y g:i a", strtotime($rec->invoice_date)) ; ?></td>
                                <td class='center'><?php echo floatval($rec->invoice_amount) ; ?></td>
								<td class='center'>
									&nbsp;<a href="<?php echo base_url("invoices/transaction/".$rec->id) ; ?>">Payment/Credit Note</a>
								<!--
